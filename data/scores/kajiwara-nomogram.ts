...
export const kajiwaraNomogram: ScoreDefinition = {
  ...
  toolKind: 'prediction',
  description:
    '内視鏡治療後の大腸T1癌におけるリンパ節転移（LNM）確率を予測します。Kajiwara 2023（GIE; 開発 3080 例）の6因子多変量ロジスティックです。合計点は SM≥2000 μm を 100 点とした nomogram 点です。公式サイトの表示と数値がややずれることがあります。本ツールは論文に記載された数値（実際のβ係数）を使って計算しています。',
  ...
  figures: [
    {
      ...
      pubmed: '36669574',
      note: '原著 Fig. 2。Elsevier / GIE の著作権。CC ではないので画像は置かず、出版社の Fig. 2 画像へリンクする。',
    },
  ],
  fields: [
    {
