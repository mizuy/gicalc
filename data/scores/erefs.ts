  ...
  entries: [
    {
      ...
      figures: [
        abeCrop({
          src: '/figures/erefs-abe2022-fig2-edema.webp',
    ...
    },
    {
      ...
      figures: [
        abeCrop({
          src: '/figures/erefs-abe2022-fig2-rings.webp',
    ...
    },
    {
      ...
      figures: [
        abeCrop({
          src: '/figures/erefs-abe2022-fig2-exudates.webp',
    ...
    },
    {
      ...
      figures: [
        abeCrop({
          src: '/figures/erefs-abe2022-fig2-furrows.webp',
    ...
    },
    {
      ...
      figures: [
        abeCrop({
          src: '/figures/erefs-abe2022-fig2-stricture.webp',
        ...
        abeCrop({
          src: '/figures/erefs-abe2022-fig2-narrow-caliber.webp',
