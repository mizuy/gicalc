...
export const UI: Record<Locale, UiStrings> = {
  ja: {
    ...
    about: {
      ...
      esophagus: '食道',
      esophagusBody:
        'JES（Oyama 2017）: Type A / B1 / B2 / B3。LA（逆流性食道炎 A–D）。Prague C & M（Barrett）。EREFS（好酸球性食道炎 0–8）。文献は PubMed に飛びます。',
      stomach: '胃',
      stomachBody:
        '木村–竹本（萎縮分類）、Hill（胃食道フラップ弁）、MESDA-G（早期胃癌の拡大診断アルゴリズム）、京都 / 改変京都 / EGGIM（胃炎リスク）、eCura / Sekiguchi（LNM）、BEST-J（ESD後出血）。',
      colorectum: '大腸',
      colorectumBody:
        'APCS（検診）、SPS（鋸歯状ポリープ症候群・WHO 2019 診断基準）、Paris（肉眼型）、LST（側方発育）、工藤–鶴田（pit pattern）、EC（超拡大・EC/EC-V）、NICE（NBI非拡大）、WASP（HP / SSL / 腺腫）、JNET（NBI拡大）、T1 Nomogram（Kajiwara）、BBPS / Aronchick（前処置）。',
      bleeding: '出血',
  ...
  en: {
    ...
    about: {
      ...
      esophagus: 'Esophagus',
      esophagusBody:
        'JES (Oyama 2017): Type A / B1 / B2 / B3. LA (reflux esophagitis A–D). Prague C & M (Barrett). EREFS (eosinophilic esophagitis 0–8). Citations open PubMed.',
      stomach: 'Stomach',
      stomachBody:
      ...
      colorectum: 'Colorectum',
      colorectumBody:
        'APCS (screening), SPS (serrated polyposis syndrome — WHO 2019 criteria), Paris (morphology), LST (laterally spreading), Kudo–Tsuruta (pit pattern), EC (ultra-magnifying EC / EC-V), NICE (NBI, non-magnifying), WASP (HP / SSL / adenoma), JNET (NBI magnifying), T1 Nomogram (Kajiwara), BBPS / Aronchick (bowel prep).',
      bleeding: 'Bleeding',
      bleedingBody:
