...
export const UI: Record<Locale, UiStrings> = {
  ja: {
    ...
    about: {
      ...
      esophagus: '食道',
      esophagusBody:
        'JES（Oyama 2017）: Type A / B1 / B2 / B3。LA（逆流性食道炎 A–D）。Prague C & M（Barrett）。EREFS（好酸球性食道炎 0–8）。食道胃静脈瘤の記載基準（L / F / C / RC。肝硬変診療ガイドライン2020の注釈つき）。文献は PubMed に飛びます。',
      stomach: '胃',
      stomachBody:
  ...
  en: {
    ...
    about: {
      ...
      esophagus: 'Esophagus',
      esophagusBody:
        'JES (Oyama 2017): Type A / B1 / B2 / B3. LA (reflux esophagitis A–D). Prague C & M (Barrett). EREFS (eosinophilic esophagitis 0–8). Esophagogastric varices recording rules (L / F / C / RC, with JSGE/JSH cirrhosis-guideline 2020 notes). Citations open PubMed.',
      stomach: 'Stomach',
      stomachBody:
