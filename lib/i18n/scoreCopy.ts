...
export type ScoreCopy = {
  ...
  /** 英語 UI のカード見出し。キーは定義側の entry.label */
  entryLabels?: Record<string, string>;
  /** 英語 UI の定義行。キーは定義側の entry.label */
  entryRows?: Record<string, Array<{ heading: string; text: string }>>;
  figureNotes?: string[];
...
export const SCORE_EN: Record<string, ScoreCopy> = {
  ...
  macro: {
    ...
    note: 'The Japanese rule texts and official English editions are not quoted. The gastric 0-I versus 0-IIa cut-off was checked in the 15th Japanese edition and aligned with the Paris columnar 2.5 mm.',
    groups: {
      隆起型: 'Protruding',
      表面型: 'Superficial',
      混合型: 'Mixed',
    ...
    meanings: {
      ...
      混合型: 'Combined components',
      '0-III': 'Deep excavation',
    },
    comments: {
      '0-I':
        'Checked in the 15th Japanese edition. The gastric cut-off is aligned with Paris at 2.5 mm. The rule text is not quoted.',
      '0-Isp':
      ...
      混合型:
        'The atlas height rule (IIc+IIa is the lower “first floor”; IIa+IIc is a relative depression on the “second floor”) is a colorectal atlas note only. The rule texts are area-first. Paris is shape.',
      '0-III':
    ...
    hierarchyLabels: {
      'macro-overview-paris': 'Paris',
      'macro-overview-esophagus': 'Esophageal rules',
      'macro-overview-stomach': 'Gastric rules',
      'macro-overview-colorectum': 'Colorectal rules',
      'macro-paris-0-i': '0-I protruding',
      'macro-paris-0-ip': '0-Ip',
      'macro-paris-0-is': '0-Is',
      'macro-paris-0-ii': '0-II superficial',
      ...
      'macro-eso-0-ip': '0-Ip',
      'macro-eso-0-is': '0-Is',
      'macro-eso-0-ii': '0-II superficial',
      'macro-eso-0-iia': '0-IIa',
      'macro-eso-0-iib': '0-IIb',
      'macro-eso-0-iic': '0-IIc',
      'macro-eso-0-mixed': 'Mixed type',
      'macro-eso-0-iii': '0-III',
      'macro-sto-0-i': '0-I',
      'macro-sto-0-ii': '0-II superficial',
      'macro-sto-0-iia': '0-IIa',
      'macro-sto-0-iib': '0-IIb',
      'macro-sto-0-iic': '0-IIc',
      'macro-sto-0-mixed': 'Mixed type',
      'macro-sto-0-iii': '0-III',
      'macro-colo-0-i': '0-I protruding',
      'macro-colo-0-ip': '0-Ip',
      'macro-colo-0-isp': '0-Isp',
      'macro-colo-0-is': '0-Is',
      'macro-colo-0-ii': '0-II superficial',
      'macro-colo-0-iia': '0-IIa',
      'macro-colo-0-iib': '0-IIb',
      'macro-colo-0-iic': '0-IIc',
      'macro-colo-0-mixed': 'Mixed type',
    },
    entryRows: {
      '0-I': [
      ...
      '0-IIa': [
        ...
        {
          heading: 'Stomach',
          text: 'Less than about 2.5 mm above the adjacent mucosa. Above that is 0-I. Same as Paris columnar epithelium.',
        },
      ...
      混合型: [
        { heading: 'Morphology', text: 'Two or more types combined. The usual pairs are 0-IIa+IIc and 0-IIc+IIa.' },
        {
          heading: 'Paris',
          text: 'Defined by shape. A relative depression (floor still above the adjacent mucosa) is 0-IIa+IIc. 0-IIc+IIa is mainly depressed, with a rim or partial elevation.',
        },
        {
          heading: 'Colorectum',
          text: 'The rule text writes the larger-area component first, joined by +. The atlas does not follow area: 0-IIc+IIa has a depressed surface below the mucosa (a conspicuous reactive rim); 0-IIa+IIc is a flat elevation whose depression is still above the mucosa (relative depression).',
        },
        { heading: 'Stomach', text: 'Write the larger-area component first, joined by +.' },
        {
          heading: 'Esophagus',
          text: 'Area-first. The component that suggests deeper invasion is placed in quotation marks (example: 0-IIc+“0-Is”). If an advanced type is mixed in, write that type first.',
        },
      ],
      '0-III': [
  ...
  'kudo-tsuruta': {
    ...
    figureNotes: [
      ...
      'Gemini-generated reference schematic supplied by a project contributor, not a figure from the Kudo–Tsuruta original. Each crop target was rasterized at high resolution for its classification card. License: CC BY 4.0.',
    ],
    entryFigureNotes: {
      'Type I': ['Extracted from the supplied Gemini-generated reference schematic and rasterized at high resolution. Not an original Kudo–Tsuruta figure. License: CC BY 4.0.'],
      'Type II': ['Extracted from the supplied Gemini-generated reference schematic and rasterized at high resolution. Not an original Kudo–Tsuruta figure. License: CC BY 4.0.'],
