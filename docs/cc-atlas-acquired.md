...
| ファイル | 分類 | 出典 | ライセンス | 中身 |
|---|---|---|---|---|
| `lst-moon2017-fig1.webp` | LST | Moon 2017 PLOS ONE Fig. 1 | CC BY 4.0 | G-H / G-M / NG-F / NG-PD × WLI+色素 |
| `serrated-dang2021-fig1.webp` | WHO serrated | Dang 2021 Can J Surg Fig. 1 | CC BY-NC-ND 4.0 | HP / SSL / TSA 病理（1枚） |
...
| `net-uccella2021-fig3.webp` | NET G1–G3 | Uccella 2021 Endocrine Fig. 3 | CC BY 4.0 | H&E + Ki-67。G1–G3 / LCNEC / SmCNEC |
| `kikuchi-nakagawa2024-fig1.webp` | Kikuchi ME-NBI | Nakagawa 2024 Dig Dis Fig. 1（PMC11457973） | CC BY-NC | absent / network / ISV / unclassified / mixed。PMC 表示解像度 |
| `paris-castaneda2022-fig1.webp` | Paris（胃） | Castañeda 2022 Cancers Fig. 1 | CC BY 4.0 | 0-I / IIa / IIb / IIc。WLI+色素。大腸ではない |
| `paris-johnson2023-fig1.webp` | Paris（模式） | Johnson 2023 Can J Surg Fig. 1 | CC BY-NC-ND 4.0 | 模式。Fig. 2 以降は許諾再掲なので未取得 |
| `erefs-sawada2025-fig1.webp` | EREFS | Sawada 2025 DEN Open Fig. 1 | CC BY 4.0 | 病理 + 内視鏡所見。PMC 表示解像度 |
